...
def make_all(transition,object_type,sym_color1,sym_color2,shape):
	...
	plt.plot(data['L_transition'][indices_err],data['FWHM'][indices_err],label=object_type,linestyle='',marker=shape,markersize=8,markerfacecolor='white',markeredgecolor=sym_color2)
...
#
#	object_type='SMG'
#	make_all(transition,object_type,'LightPink','DarkRed','o')
#	#object_type='BzK'
#	#make_all(transition,object_type,'LightGreen','DarkGreen','p')
#	#object_type='HzRG'
#	#make_all(transition,object_type,'LightBlue','DarkBlue','h')
#	object_type='QSO'
...
#	make_all(transition,object_type,'LightPink','DarkRed','o')
#	object_type='ULIRG'
#	make_all(transition,object_type,'LightBlue','DarkBlue','8')
#	object_type='BzK'
#	make_all(transition,object_type,'LightGreen','DarkGreen','p')
#	object_type='QSO'
#	make_all(transition,object_type,'Grey','Black','^')
#	object_type='OFRG'
#	make_all(transition,object_type,'Black','Black','s')
#
