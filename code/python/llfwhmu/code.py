...
def make_L_transition_Redshift(transition,object_type,sym_color1,sym_color2,shape):
	...
	data = Extract_EMGs_CSV(object_id='all',object_type=object_type, transition=transition,flag_include='no',verbose='no')
	...
	plt.plot(data['z'][indices_err],data['L_transition'][indices_err],label=object_type,linestyle='',marker=shape,markersize=8,markerfacecolor='white',markeredgecolor=sym_color2)
        plt.legend(handler_map={object_type: HandlerLine2D(numpoints=1)},bbox_to_anchor=(0.90, 0.85),
           bbox_transform=plt.gcf().transFigure)


#	if indices_upper_limit != []:
#		plt.errorbar(data['z'][indices_upper_limit],data['L_transition'][indices_upper_limit],uplims=True,fmt="none",yerr=2.E9,ecolor=sym_color2)
#		plt.plot(data['z'][indices_upper_limit],data['L_transition'][indices_upper_limit],marker='o',markersize=8,markerfacecolor=sym_color1,markeredgecolor=sym_color2)
...
#	data = Extract_EMGs_CSV(object_id='all',object_type='all', transition='12CO(1-0)',flag_include='no',verbose='no')
 #       print data['type']
...
#	object_type='SMG'
#	make_L_transition_Redshift(transition,object_type,'LightPink','DarkRed','o')
#	object_type='BzK'
#	make_L_transition_Redshift(transition,object_type,'LightGreen','DarkGreen','p')
#	object_type='HzRG'
#	make_L_transition_Redshift(transition,object_type,'LightBlue','DarkBlue','h')
#	object_type='QSO'
#	make_L_transition_Redshift(transition,object_type,'Grey','Black','^')
#	object_type='LBG'
#	make_L_transition_Redshift(transition,object_type,'Grey','Black','D')
...
#	make_L_transition_Redshift(transition,object_type,'LightPink','DarkRed','o')
#	object_type='ULIRG'
#	make_L_transition_Redshift(transition,object_type,'LightBlue','DarkBlue','8')
#	object_type='BzK'
#	make_L_transition_Redshift(transition,object_type,'LightGreen','DarkGreen','p')
#	object_type='QSO'
#	make_L_transition_Redshift(transition,object_type,'Grey','Black','^')
#	object_type='OFRG'
#	make_L_transition_Redshift(transition,object_type,'Black','Black','s')
#
